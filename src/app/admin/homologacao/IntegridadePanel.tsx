...
/**
 * GO-H8C/H10A — Painel de Integridade (embutível na Homologação).
 */
...
export function IntegridadePanel({ embedded = false }: { embedded?: boolean }) {
    ...
    <div className="space-y-6">
      {!embedded && (
        <Callout intent="info">
          ...
          Alta/Média exigem ação; Informativo é rastreabilidade.
        </Callout>
      )}
